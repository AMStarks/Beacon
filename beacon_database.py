    ...
    def init_database(self):
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                # Create articles table (unified schema)
                cursor.execute('''
                ...
                # Create clusters table used by feed/clustering
                cursor.execute('''
    ...
    def update_article(self, article_id: int, **kwargs) -> bool:
        ...
        try:
            ...
            for key, value in kwargs.items():
                if key in [
                    'url', 'date_sourced', 'date_written', 'title', 'content', 'excerpt', 'source',
                    'updated_at', 'identifier_1', 'identifier_2', 'identifier_3',
                    'identifier_4', 'identifier_5', 'identifier_6', 'cluster_id'
                ]:
                    fields.append(f"{key} = ?")
                    values.append(value)
