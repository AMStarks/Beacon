"""
Simple News Collection System
Compatible with Python 3.13 - no feedparser dependency
"""
...
class SimpleNewsCollector:
    """Simple news collector using web scraping and APIs"""
    ...
    async def collect_articles(self) -> List[NewsArticle]:
        ...
        # Collect from simple web scraping
    ...
    async def _extract_article(self, url: str, source: Dict) -> Optional[NewsArticle]:
        ...
        try:
            ...
            content = " ".join([elem.get_text().strip() for elem in content_elems[:5]])  # First 5 paragraphs
